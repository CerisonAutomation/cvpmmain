      ...
      >
        <div className="flex gap-4 p-4">
          ...
          <div className="flex-1 min-w-0">
            <h3 className="heading text-[#F5F5F0] font-semibold mb-1 truncate">
              {listing.title}
            </h3>
    ...
    <div className="min-h-screen bg-[#0F0F10] pt-24">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-20 py-6 border-b border-white/5">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="heading text-3xl text-[#F5F5F0] font-semibold mb-2">
              Map View
            </h1>
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-20 py-6">
        <div className="flex gap-6 h-[calc(100vh-240px)]">
          ...
          {(viewMode === "split" || viewMode === "map") && (
            <div className={`${viewMode === "split" ? "flex-1" : "w-full"} border border-white/10 overflow-hidden`} style={{ isolation: "isolate", zIndex: 0 }}>
              <MapContainer
