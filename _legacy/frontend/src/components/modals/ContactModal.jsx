...
export const ContactModal = () => {
  ...
  const modalCms = cms.modals?.contact || {};
  const modalTitle = modalCms.title || "Get in Touch";
  const modalSubtitle = modalCms.subtitle || "We typically respond within a few hours";
  const successTitle = modalCms.successTitle || "Message Sent!";
  const successText = modalCms.successText || "Thank you for reaching out. We'll get back to you within 24 hours.";
  const QUICK_SUBJECTS = modalCms.subjects || ["Booking Inquiry", "Property Question", "Availability Check", "Special Request", "Other"];
        ...
        {isSuccess ? (
          ...
          <>
            <DialogHeader className="p-6 pb-0">
              ...
              <p className="text-[#A1A1AA] text-sm mt-2">{modalSubtitle}</p>
            </DialogHeader>
