...
export const PropertyOwnerModal = () => {
  ...
  const { cms } = useCMS();
  const ownerCms = cms.modals?.owner || {};
  const modalTitle = ownerCms.title || "List Your Property";
  const successTitle = ownerCms.successTitle || "Inquiry Received!";
  const successText = ownerCms.successText || "Thank you for your interest. We'll review your property details and contact you within 48 hours.";
  const step1Desc = ownerCms.step1Desc || "Tell us about your property";
  const step2Desc = ownerCms.step2Desc || "Your contact information";
  const step3Desc = ownerCms.step3Desc || "Services you're interested in";
      ...
      <DialogContent className="bg-[#0F0F10] border-white/10 max-w-xl p-0 overflow-hidden max-h-[90vh] overflow-y-auto">
        {isSuccess ? (
          <div className="p-8 text-center">
            ...
            <h3 className="heading text-2xl text-[#F5F5F0] mb-3">{successTitle}</h3>
            <p className="text-[#A1A1AA] mb-6">{successText}</p>
            <Button
              onClick={handleClose}
          ...
          <div className="p-6">
            <DialogHeader className="mb-4">
              <DialogTitle className="heading text-2xl text-[#F5F5F0]">{modalTitle}</DialogTitle>
              <p className="text-[#A1A1AA] text-sm">
                {ownerModalStep === 1 && step1Desc}
                {ownerModalStep === 2 && step2Desc}
                {ownerModalStep === 3 && step3Desc}
              </p>
            </DialogHeader>
