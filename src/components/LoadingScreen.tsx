...
export default function LoadingScreen({ onComplete }: LoadingScreenProps) {
  ...
  useEffect(() => {
    const timers = [
      ...
      setTimeout(() => setPhase(2), 800),     // Map starts drawing
      setTimeout(() => setPhase(3), 2600),    // Fill + glow
      setTimeout(() => setPhase(4), 3400),    // Exit
      ...
      {phase < 5 ? (
        ...
        >
          ...
          <div className="absolute inset-0 pointer-events-none" style={{
            background: 'radial-gradient(ellipse 55% 50% at 50% 55%, rgba(60,35,10,.12) 0%, transparent 70%)'
          }} />
          ...
          <div className="absolute inset-0 pointer-events-none" style={{
            zIndex: 2,
            background: 'radial-gradient(ellipse 65% 60% at 50% 50%, transparent 0%, rgba(8,6,4,.6) 60%, rgba(4,3,2,.95) 100%)'
          }} />
          ...
          <div className="fixed inset-0 z-10 flex flex-col items-center justify-center px-6">
            ...
            >
              <img 
                ...
                style={{
                  filter: 'drop-shadow(0 4px 24px rgba(180,140,60,.15))'
                }}
              />
            ...
            <div
              ...
              style={{
                width: 'min(380px, 50vw, 42vh)',
                opacity: phase >= 2 ? 1 : 0,
                transform: phase >= 2 ? 'translateY(0) scale(1)' : 'translateY(6px) scale(0.98)',
              }}
            >
              {/* Warm underglow */}
              <div
                ...
                style={{
                  bottom: '-15%', left: '10%', right: '10%', height: '35%',
                  background: 'radial-gradient(ellipse at 50% 0%, rgba(160,110,40,.1) 0%, transparent 70%)',
                  filter: 'blur(20px)',
                  opacity: phase >= 3 ? 1 : 0,
                }}
              />
              ...
              <svg
                ...
                style={{
                  ...
                  animation: phase >= 3 ? 'floatMap 7s ease-in-out infinite' : 'none',
                }}
              >
                <defs>
                  <linearGradient id="goldFill" x1="0" y1="0" x2="1" y2="1">
                    <stop offset="0%" stopColor="rgba(200,160,70,0.12)" />
                    <stop offset="50%" stopColor="rgba(180,140,50,0.08)" />
                    <stop offset="100%" stopColor="rgba(160,120,40,0.04)" />
                  </linearGradient>
                </defs>
                ...
                <path
                  ...
                  d={GOZO_D}
                  style={{
                    fill: phase >= 3 ? 'url(#goldFill)' : 'transparent',
                    stroke: 'rgba(180,140,60,.45)',
                    strokeWidth: 2.5,
                    strokeLinejoin: 'round',
                    strokeDasharray: 'var(--len, 3000)',
                    strokeDashoffset: phase >= 2 ? '0' : 'var(--len, 3000)',
                    transition: 'stroke-dashoffset 2s cubic-bezier(.4,0,.2,1), fill 1.5s ease',
                  }}
                />
                ...
                <path
                  ...
                  style={{
                    ...
                    strokeDashoffset: phase >= 2 ? '0' : 'var(--len, 6000)',
                    transition: 'stroke-dashoffset 2s cubic-bezier(.4,0,.2,1), fill 1.5s ease',
                  }}
                />
              </svg>
            ...
            {/* MALTA text with shimmer */}
            <div
              className="mt-6 transition-all duration-[1000ms]"
              style={{
            ...
            >
              <span className="gold-text">MALTA</span>
            </div>
          </div>
          ...
          <div
            ...
            style={{
              ...
              transition: phase >= 4 ? 'transform 0.9s cubic-bezier(.76,0,.24,1)' : 'none',
            }}
          />
        </motion.div>
      ) : null}
